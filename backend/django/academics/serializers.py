...
class UserSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ['id', 'username', 'email', 'role', 'department', 'first_name', 'last_name', 'is_active']
...
class FacultySerializer(serializers.ModelSerializer):
    ...
    max_workload = serializers.IntegerField(source='max_workload_per_week', read_only=True)
...
class AttendanceSerializer(serializers.ModelSerializer):
    ...
    subject_name = serializers.CharField(source='slot.subject.subject_name', read_only=True)
