...
class AttendanceRecordSerializer(serializers.ModelSerializer):
    ...
    marked_by_name = serializers.CharField(
        source="marked_by.faculty_name", read_only=True
    )
...
class StudentAttendanceSummarySerializer(serializers.Serializer):
    ...
    total_sessions = serializers.IntegerField(source='total_classes')
    present_count = serializers.IntegerField(source='classes_attended')
    absent_count = serializers.IntegerField(source='classes_missed')
