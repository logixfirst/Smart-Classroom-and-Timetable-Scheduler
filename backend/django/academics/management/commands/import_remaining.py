...
from academics.models import (
    User, Department, Course, Batch, Classroom, Lab
)
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        root_dir = os.path.dirname(os.path.dirname(root_dir))  # Go up from django/academics/management/commands
        ...
        with open(file_path, 'r', encoding='utf-8') as file:
            ...
            for row in reader:
                try:
                    ...
                    self.stdout.write(self.style.WARNING(f'Skipping lab {row["lab_id"]}: {e}'))
