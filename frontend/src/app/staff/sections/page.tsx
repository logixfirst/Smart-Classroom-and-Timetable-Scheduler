    ...
    <DashboardLayout role="staff">
      <div className="space-y-4 sm:space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-800 dark:text-gray-200">Batch & Section Management</h1>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
          <div className="card p-3 sm:p-4">
            <h3 className="font-medium text-xs sm:text-sm text-gray-800 dark:text-gray-200 mb-2">Total Batches</h3>
          ...
          <div className="card p-3 sm:p-4">
            <h3 className="font-medium text-xs sm:text-sm text-gray-800 dark:text-gray-200 mb-2">Active Sections</h3>
          ...
          <div className="card p-3 sm:p-4">
            <h3 className="font-medium text-xs sm:text-sm text-gray-800 dark:text-gray-200 mb-2">Avg. Size</h3>
          ...
          <div className="card p-3 sm:p-4">
            <h3 className="font-medium text-xs sm:text-sm text-gray-800 dark:text-gray-200 mb-2">Pending Setup</h3>
                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3">
                  <div className="flex-1 min-w-0">
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 mb-3">
                      <h4 className="font-medium text-sm sm:text-base text-gray-800 dark:text-gray-200">{batch.name}</h4>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-center">
                      <div className="p-2 bg-white dark:bg-[#2a2a2a] rounded">
                        <p className="text-sm sm:text-base font-bold text-gray-800 dark:text-gray-200">{batch.students}</p>
