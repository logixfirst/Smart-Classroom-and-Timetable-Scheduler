      ...
      <div className="space-y-4 sm:space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
          <div className="card">
            ...
            <div className="space-y-3 sm:space-y-4">
              <div className="form-group">
                <label htmlFor="start-time" className="form-label text-sm sm:text-base">Preferred Start Time</label>
              ...
              <div className="form-group">
                <label htmlFor="end-time" className="form-label text-sm sm:text-base">Preferred End Time</label>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  {['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'].map(day => (
                    <label key={day} htmlFor={`day-${day.toLowerCase()}`} className="flex items-center gap-2">
                      <input id={`day-${day.toLowerCase()}`} type="checkbox" className="rounded w-4 h-4" defaultChecked={day !== 'Saturday'} />
          ...
          <div className="card">
            ...
            <div className="space-y-3 sm:space-y-4">
              <div className="form-group">
                <label htmlFor="max-classes" className="form-label text-sm sm:text-base">Maximum Classes Per Day</label>
              ...
              <div className="form-group">
                <label htmlFor="room-type" className="form-label text-sm sm:text-base">Preferred Room Type</label>
              ...
              <div className="form-group">
                <label htmlFor="break-time" className="form-label text-sm sm:text-base">Break Between Classes</label>
              ...
              {['09:00', '10:00', '11:00', '12:00', '13:00', '14:00', '15:00', '16:00'].map(time => (
                <div key={time} className="contents">
                  ...
                  {Array.from({length: 6}).map((_, i) => {
                    ...
                    return (
                      <button key={i} aria-label={`Toggle availability for ${days[i]} at ${time}`} className="p-1 sm:p-2 border border-gray-200 dark:border-gray-700 rounded hover:bg-[#f5f5f5] dark:hover:bg-[#3c4043] transition-colors">
