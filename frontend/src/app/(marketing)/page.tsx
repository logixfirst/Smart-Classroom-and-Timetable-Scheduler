...
export default function HomePage() {
  return (
    <div style={{ background: 'var(--cadence-off-white)' }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div style={{ background: 'rgba(239,68,68,0.03)', border: '1px solid rgba(239,68,68,0.12)', borderRadius: '16px', padding: '32px' }}>
              <h3 style={{ fontFamily: 'Poppins, sans-serif', fontSize: '18px', fontWeight: 600, color: '#b91c1c', marginBottom: '24px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                <span style={{ background: 'rgba(239,68,68,0.1)', borderRadius: '8px', padding: '4px 8px', fontSize: '12px', fontWeight: 700 }}>
                  The old way
                </span>
              </h3>
            ...
            {/* Cadence way */}
            <div style={{ background: 'rgba(26,115,232,0.03)', border: '1px solid rgba(26,115,232,0.16)', borderRadius: '16px', padding: '32px' }}>
              <h3 style={{ fontFamily: 'Poppins, sans-serif', fontSize: '18px', fontWeight: 600, color: 'var(--cadence-teal)', marginBottom: '24px' }}>
                <span style={{ background: 'rgba(26,115,232,0.10)', borderRadius: '8px', padding: '4px 8px', fontSize: '12px', fontWeight: 700 }}>
                  With Cadence
                </span>
              </h3>
              <ul className="flex flex-col gap-4">
                {CADENCE_WAY.map(item => (
                  <li key={item} style={{ display: 'flex', alignItems: 'flex-start', gap: '12px' }}>
                    <div style={{ width: '20px', height: '20px', borderRadius: '50%', background: 'rgba(26,115,232,0.12)', border: '1px solid rgba(26,115,232,0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, marginTop: '1px' }}>
                      <Check size={11} color="#1A73E8" />
                    </div>
                    <span style={{ fontFamily: 'Inter, sans-serif', fontSize: '15px', color: 'var(--cadence-slate)', lineHeight: '1.5' }}>{item}</span>
                  </li>
                ))}
              ...
              <div key={i} style={{ display: 'flex', alignItems: 'stretch', gap: '16px' }}>
                <div className="mk-feature-card" style={{ textAlign: 'left', flex: 1 }}>
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '20px' }}>
                    <div style={{ width: '52px', height: '52px', borderRadius: '14px', background: 'rgba(26,115,232,0.10)', border: '1px solid rgba(26,115,232,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                      {step.icon}
                    </div>
                    <span style={{ fontFamily: 'Poppins, sans-serif', fontSize: '36px', fontWeight: 800, color: 'rgba(21,88,214,0.08)', lineHeight: 1 }}>
                      {step.step}
                    </span>
                  </div>
      ...
      {/* 6 — Testimonial ─────────────────────────────────────────────────── */}
      <section style={{ background: '#e8f0fe', padding: '80px 24px' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
          <Quote size={48} color="#1A73E8" style={{ marginBottom: '24px', margin: '0 auto 24px' }} />
          <blockquote style={{ fontFamily: 'Poppins, sans-serif', fontSize: 'clamp(18px,2.5vw,22px)', fontWeight: 400, fontStyle: 'italic', color: '#202124', lineHeight: 1.65, marginBottom: '36px' }}>
          ...
          <div>
            <p style={{ fontFamily: 'Poppins, sans-serif', fontSize: '16px', fontWeight: 600, color: '#202124', marginBottom: '4px' }}>
              Dr. Ananya Krishnan
            </p>
            <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '14px', color: '#5F6368' }}>
      ...
      {/* 8 — Final CTA ───────────────────────────────────────────────────── */}
      <section style={{ background: '#e8f0fe', padding: '100px 24px' }}>
        <div style={{ maxWidth: '700px', margin: '0 auto', textAlign: 'center' }}>
          <h2 className="mk-h2" style={{ marginBottom: '20px', color: '#1558D6' }}>
            Ready to end scheduling chaos?
          </h2>
          <p style={{ fontFamily: 'Inter, sans-serif', fontSize: 'clamp(16px,2vw,20px)', color: '#5F6368', marginBottom: '40px', lineHeight: 1.6 }}>
          ...
          <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '13px', color: '#5F6368', marginTop: '16px' }}>
