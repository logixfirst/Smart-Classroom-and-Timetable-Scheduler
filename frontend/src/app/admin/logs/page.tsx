...
export default function LogsPage() {
  const logs = [
    { id: 1, timestamp: "2023-10-15 14:30:25", level: "INFO", action: "User Login", user: "harsh.sharma@sih28.edu", details: "Admin login successful" },
    { id: 2, timestamp: "2023-10-15 14:25:12", level: "SUCCESS", action: "Timetable Generated", user: "system", details: "CS Semester 5 timetable generated successfully" },
    { id: 3, timestamp: "2023-10-15 14:20:08", level: "WARNING", action: "Failed Login", user: "unknown@sih28.edu", details: "Invalid credentials attempt" },
    { id: 4, timestamp: "2023-10-15 14:15:45", level: "INFO", action: "User Created", user: "harsh.sharma@sih28.edu", details: "New faculty member added: Dr. Rajesh Kumar" },
    { id: 5, timestamp: "2023-10-15 14:10:33", level: "ERROR", action: "System Error", user: "system", details: "Database connection timeout" },
  ]
      ...
      <div className="space-y-4 sm:space-y-6">
        ...
        <div className="card">
          ...
          <div className="block sm:hidden space-y-3">
            {logs.map((log) => (
              <div key={log.id} className="p-4 bg-gray-50 dark:bg-[#3c4043] rounded-lg border border-gray-200 dark:border-gray-600">
                <div className="flex items-start justify-between mb-2">
                  ...
                  <span className={`badge ml-2 ${
                    ...
                    log.level === 'ERROR' ? 'badge-danger' : 'badge-info'
                  }`}>
                    {log.level}
                  </span>
                </div>
          ...
          <div className="hidden sm:block overflow-x-auto">
            <table className="table">
              ...
              <tbody>
                {logs.map((log) => (
                  <tr key={log.id} className="hover:bg-gray-50 dark:hover:bg-[#3c4043] transition-colors duration-200">
